...
import 'chat_ai_screen_copy_widget.dart' show ChatAiScreenCopyWidget;
import 'package:flutter/material.dart';

class ChatAiScreenCopyModel extends FlutterFlowModel<ChatAiScreenCopyWidget> {
  ...
  // Stores action output result for [Backend Call - API (threads)] action in chat_ai_ScreenCopy widget.
